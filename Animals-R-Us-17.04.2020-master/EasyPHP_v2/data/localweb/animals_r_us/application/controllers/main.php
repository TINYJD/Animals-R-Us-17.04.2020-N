...
class Main extends CI_Controller {
	...
	{	
		...
		$crud->columns('Animal_ID', 'Animal_Name', 'Owner_ID', 'Height', 'Weight', 'Condition_Name', 'Availability', 'Condition_ID');
	
		//the fields function lists attributes to see on add/edit forms.
		//Note no inclusion of invoiceNo as this is auto-incrementing
		$crud->fields ('Animal_Name', 'Owner_ID', 'Height', 'Weight', 'Condition_Name','Availability', 'Condition_ID');
		...
		//$crud->set_relation('Condition_Level','diagnosis', 'Condition_Level');
		$crud->set_relation('Owner_ID','owner', '{Given_Name} {Family_Name}' );
		$crud->set_relation('Condition_ID','skill_level', '{Condition_Level}' );
	...
	{	
		...
		$crud->set_relation('Animal_ID', 'Animal', '{Animal_Name}');
		$crud->set_relation('Lesson_ID', 'Vetlesson', '{Lesson_Date}  - {Lesson_Time}');
		
		
		$crud->display_as('Vetlesson', 'Lesson');
		$crud->display_as('animalsinlesson', 'Animals in lesson');
		$crud->display_as('Animal_ID', 'Animal');
		$crud->display_as('Lesson_ID', 'Lesson');
	...
	{	
		...
		$crud->display_as('Mobile_Number', 'Telephone Number');
	...
	{	
		...
		$crud->columns('Trainee_ID','Given_Name', 'Family_Name', 'Current_level');
		$crud->fields('Given_Name', 'Family_Name', 'Current_level');
		$crud->required_fields('Trainee_ID','Given_Name', 'Family_Name', 'Current_level');
		$crud->set_relation('Current_level','skill_level', '{Condition_Level}' );
	...
	{	
		...
		$crud->display_as('Trainee_ID', 'Trainee');
		$crud->display_as('Lesson_No', 'Lesson');
		$crud->set_relation('Trainee_ID','trainee', '{Given_Name} {Family_Name}');
		$crud->set_relation('Lesson_No', 'vetlesson', '{Lesson_Date} - {Lesson_Time}');
	...
	{	
		...
		$crud->set_relation('Lesson_Level','Skill_Level', 'Condition_ID');
		$crud->set_relation('Lesson_Level','Skill_Level', '{Condition_Level}');
