...
<body>
	<div>
		...
		<li><a href='<?php echo site_url('main/animalsinlesson')?>'>Animal Bookings</a></li>
		<li><a href='<?php echo site_url('main/owner')?>'>Owner</a></li>
		<li><a href='<?php echo site_url('main/trainee')?>'>Trainee</a></li>
		<li><a href='<?php echo site_url('main/traineesinlesson')?>'>Trainee Bookings</a></li>
		<li><a href='<?php echo site_url('main/vetlesson')?>'>Vet Lessons</a></li>
			<ul id="rightnav">
			<li><a href='<?php echo site_url('main/faqs')?>'>FAQS</a></li>
