...
<head>
	<meta charset="utf-8" />
	<style>
	#nav { font-family: Garamond; font-size: 14px; width: 100%; float: left; margin: 0 0 1em 0; padding: 0; list-style: none;}
...
<body>
	<div>
		...
		<li><a href='<?php echo site_url('main/Animal')?>'>Animal</a></li>
		<li><a href='<?php echo site_url('main/animalsinlesson')?>'>Animals in lesson</a></li>
		<li><a href='<?php echo site_url('main/owner')?>'>Owner</a></li>
		<li><a href='<?php echo site_url('main/diagnosis')?>'>Diagnosis</a></li>	
		<li><a href='<?php echo site_url('main/trainee')?>'>Trainee</a></li>
